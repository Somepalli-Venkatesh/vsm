...
const { register, login, verifyOTP,getNotifications,getUserById,searchUsers,respondToGroupInvite, sendGroupInvite,resendOTP ,createGroup,getGroups,profile} = require('../controllers/authController');
